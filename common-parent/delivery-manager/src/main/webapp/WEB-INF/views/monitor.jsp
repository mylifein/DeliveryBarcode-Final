...
<head>
    ...
    <style type="text/css">
        ...
        #times{border: 1px solid greenyellow;color: #ffffff}
    </style>
</head>
                ...
                <div class="card">
                    <div class="card card-info">
                        <div class="card-header">
                            <h6 class="card-title">生产看板-组装C线</h6>
                    ...
                    <div class="card-body p-0" >
                        <div class="box-header with-border">
                            <h6 class="box-title" style="float:right"><span style="color: orangered;height: 5px">最近7天未结工单</span></h6>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success) {
                        ...
                        for (let monitorInfo of monitorInfos) {
                            innerElement += '<tr style="height: min-content;padding: 0px"><td>' + monitorInfo.workNo + '</td><td>' + monitorInfo.delMatno + '</td><td><span class="label label-success">' + monitorInfo.woQuantity + '</span></td><td>' + monitorInfo.prodlineDesc + '</td><td>' + monitorInfo.totalQty + '</td>';
                            var prodRate = Math.floor(monitorInfo.totalQty/monitorInfo.woQuantity *10000/100.00);
                            innerElement += '<td><span class="badge badge-info">' + prodRate+ '%</span></td>';
