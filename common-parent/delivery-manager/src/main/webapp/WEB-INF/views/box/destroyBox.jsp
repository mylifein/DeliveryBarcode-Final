        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">箱号作废</li>
            </ol>
          </div><!-- /.col -->
            ...
            <tr>
              <td>
                <div class="form-group row">
                  <label for="barcode" class="col-sm-3 col-form-label">箱号条码</label>
                  <div class="col-sm-9">
              ...
              <td>
                <div class="form-group row">
                <div class="col-sm-10">
                  <input type="button" class="btn btn-success btn-lg" id="shippingBtn" value="作废">
                </div>
                </div>
              </td>
            </tr>
...
<script>
  $(function() {
    ...
    $('#shippingBtn').click(function () {
      ...
      $.ajax({
        url:'${pageContext.request.contextPath}/box/disconnect.do',
