                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">装箱单条码报表</li>
                        </ol>
                    </div><!-- /.col -->
                ...
                <div class="card">
                    <div class="card card-info">
                        <div class="card card-header">
                            <h3 class="card-title">装箱单条码报表</h3>
                        </div>
                    </div>
                    <div class="card card-body">
                        <div class="form-group row">
                            <label for="dept" class="col-sm-1 col-form-label">生产部门</label>
                            <div class="col-sm-2">
                                <select type="text" class="form-control" name="dept" id="dept" readonly>
                                </select>
                            </div>
                            <label for="prodLine" class="col-sm-1 col-form-label">线别</label>
                            <div class="col-sm-2">
                                <select type="text" class="form-control" name="prodLine" id="prodLine" readonly>
                                </select>
                            </div>
                            <label for="status" class="col-sm-1 col-form-label">装箱单状态</label>
                            <div class="col-sm-2">
                                <select type="text" class="form-control" name="status" id="status" readonly>
                                    <option value="0">已打包</option>
                                    <option value="1">已装栈板</option>
                                    <option value="2">已入库</option>
                                    <option value="3">已出货</option>
                                    <option value="">全部</option>
                                </select>
                            </div>
                            <label for="workNo" class="col-sm-1 col-form-label">工单</label>
                            <div class="col-sm-2">
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.success) {
                    ...
                    $('#dept').append('<option value="">请选择生产部门</option>');
            ...
            "columnDefs": [
                {
                    ...
                    "data": "cartonStatus", // 数据列名
                    "render": function (data, type, full) { // 返回自定义内容
                        var packType;
                        switch (data) {
                            case '0':
                                packType = "<span class='badge badge-info'>已装箱</span>";
                                break;
                            case '1':
                                packType = "<span class='badge badge-primary'>已裝棧板</span>";
                                break;
                            case '2':
                                packType = "<span class='badge badge-secondary'>已入库</span>";
                                break;
                            case '3':
                                packType = "<span class='badge badge-success'>已出货</span>";
                                break;
                        }
                        return packType;
                    }
                },
                {
                    ...
                    "render": function (data, type, full) { // 返回自定义内容
                        ...
                        switch (data) {
                            case '0':
                                packType = "<span class='badge badge-success'>整机</span>";
                                break;
                            case '1':
                                packType = "<span class='badge badge-info'>单出</span>";
                                break;
                        }
                        return packType;
                    }
